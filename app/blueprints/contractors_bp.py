...
def add_contractor():
    try:
        ...
        new_cont, category = create_contractor(current_user.id, data)
...
def edit_contractor(c_id):
    try:
        ...
        cont, category = update_contractor(current_user.id, c_id, data)
...
def delete_contractor(c_id):
    try:
        soft_delete_contractor(current_user.id, c_id)
